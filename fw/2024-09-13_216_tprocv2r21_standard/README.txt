move generators around, now all of the int4 gens work (previous version has some bug with the int4s on tiles 0 and 1)
...
Firmware configuration (built Fri Sep 13 20:50:31 2024):
	...
	tProc qick_processor ("v2") rev 21: program memory 4096 words, data memory 4096 words
